...
import 'package:quizappflutter/Screen/teacher_screen/teacher_dashboard.dart';
import 'package:quizappflutter/Screen/login&signup/signup.dart';
                      ...
                      onTap: () async {
                        if (_formkey.currentState!.validate()) {
                          ...
                          if (userCredential != null) {
                            ...
                            bool isTeacher =
                                (snapshot.data() as Map<String, dynamic>)['IsTeacher'] as bool? ?? false;
